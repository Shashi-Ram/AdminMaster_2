...
namespace AdminMaster.Repository.Services
{
    public class AccountService : IUsers
    {
        ...
        private void SendMail(string to, string OTP)
        {
            ...
            mail.To.Add(to);
            mail.From = new MailAddress("srbhardwaj25@gmail.com");
            ...
            smtp.Credentials = new System.Net.NetworkCredential("srbdemo25@gmail.com"," Forgetme25");  // enter senders user name and password
            smtp.EnableSsl = true;
            smtp.Send(mail);
        }
